...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f9fafb" }}>
      ...
      {/* Header with logo */}
      <div style={{ background: "#1e3a5f", padding: "0.75rem 1rem", display: "flex", justifyContent: "center", alignItems: "center", borderBottom: "3px solid #D85A30" }}>
      ...
      {/* First-visit privacy notice — green */}
      {showNotice && (
        <div style={{ background: "#F0FDF4", padding: "0.6rem 1rem", display: "flex", justifyContent: "center", alignItems: "center", gap: 12, flexWrap: "wrap", fontFamily: "sans-serif", borderBottom: "1px solid #BBF7D0" }}>
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <button
              ...
              style={{ fontSize: 12, color: "#166534", background: "rgba(0,0,0,0.08)", border: "none", borderRadius: 6, padding: "3px 10px", cursor: "pointer", fontFamily: "inherit" }}
            >
              Got it ✕
            </button>
          </div>
      ...
      {/* Site footer — navy */}
      <div style={{ background: "#1e3a5f", borderTop: "3px solid #D85A30", padding: "1.25rem 1rem", textAlign: "center", fontFamily: "sans-serif" }}>
        <img src="/icon-512.png" alt="logo" style={{ height: 36, width: 36, borderRadius: 6, marginBottom: 8 }} />
        <div style={{ fontSize: 12, color: "#7BAFD4", marginTop: 4, lineHeight: 2 }}>
          © 2026 Our Road Trip Planner™ &nbsp;·&nbsp;
          <a href="/terms" style={{ color: "#7BAFD4", textDecoration: "none" }}>Terms</a> &nbsp;·&nbsp;
          <a href="/privacy" style={{ color: "#7BAFD4", textDecoration: "none" }}>Privacy</a> &nbsp;·&nbsp;
          <a href="/affiliate-disclosure" style={{ color: "#7BAFD4", textDecoration: "none" }}>Affiliate Disclosure</a> &nbsp;·&nbsp;
          <a href="/privacy" style={{ color: "#7BAFD4", textDecoration: "none" }}>Do Not Sell My Info</a>
        </div>
        <div style={{ fontSize: 11, color: "#4a6f96", marginTop: 6 }}>
          AI-generated itineraries for planning purposes only. Always verify conditions before travel.
        </div>
        <div style={{ fontSize: 11, color: "#4a6f96", marginTop: 4 }}>
